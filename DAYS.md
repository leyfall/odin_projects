...
Learning that the phase of learning to code (again) will be very much painful, knowing you can do it for the best.

       (which was written by the founder of The Odin Project. This article gives a realistic view of what the journey ahead is like)
       
 Web design reading it on wiki. 
...
- (done) Watch “What is Git?” explained in 2 minutes - a video about what Git is and how it can improve the workflow of both an individual and a team of developers.
